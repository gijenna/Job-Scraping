...
const numberBadge = { display: 'inline-block', padding: '4px 12px', borderRadius: '999px', backgroundColor: '#ED7660', color: '#ffffff', fontSize: '14px', fontWeight: 'bold', margin: '0 0 16px' }
...
const matchNumber = { display: 'inline-block', fontWeight: 'bold', color: '#E1B624', margin: '0 0 4px', fontSize: '14px' }
...
const button = { backgroundColor: '#ED7660', color: '#ffffff', padding: '12px 24px', borderRadius: '8px', textDecoration: 'none', fontSize: '15px', fontWeight: 'bold', display: 'inline-block', margin: '8px 0' }
