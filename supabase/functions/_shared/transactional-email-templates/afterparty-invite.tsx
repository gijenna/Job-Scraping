...
interface AfterPartyInviteProps {
  ...
  invitedBy?: string; // "Basecamp" | "Popfly" | "Outside" | undefined
}
    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          {invitedBy && (
            <Text style={inviterTag}>
              Lucky you. {invitedBy} wants you there.
            </Text>
          )}
          ...
          <Text style={text}>
            Fill out your profile and we'll match you with your <strong>5 people</strong> for the night, creators,
            brands, and industry folks worth saying hi to.
          </Text>
          <Text style={text}>The more you fill in, the better the matches. Takes about 3 minutes.</Text>

          <Button href={inviteUrl} style={button}>
            RSVP here, {recipientName} →
          </Button>
          ...
          {role === "brand" && (
            <>
              ...
              <Text style={text}>
                Tap below and I'll personally reach out within one business day to walk through activation options,
                product moments, branded touches, anything that fits the night.
              </Text>
...
export const template = {
  ...
  subject: (data: Record<string, any>) => {
    ...
    return `${first}, you're in for the Creator After Party`;
  },
...
const footer = { fontSize: "13px", color: "#666", margin: "0 0 12px", lineHeight: "1.6" };
