          ...
          <section id="learn-more" className="bg-events-teal py-16 md:py-24">
            <div className="max-w-4xl mx-auto px-4">
              ...
              <p className="text-events-cream/60 text-lg text-center mt-6 max-w-2xl mx-auto leading-relaxed">
                Your company will have a <strong className="text-events-coral">Discovery Zone</strong>, a branded space
                to tell your unique story and chat with job seekers who are genuinely interested in what you do.
                You'll be a huge help to the team and the community.
              </p>
              <p className="text-events-cream/70 text-lg text-center mt-4 max-w-2xl mx-auto leading-relaxed">
                ...
                so they can have questions ready and know to look for you. Your profile card will be published on our
                website before the event so people can prepare meaningful conversations with you.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12">
                <div className="bg-events-card/60 rounded-xl border border-events-cream/10 p-6 text-center">
                  <div className="w-12 h-12 rounded-full bg-events-coral/20 flex items-center justify-center mx-auto">
                    <Building2 className="w-6 h-6 text-events-coral" />
                  </div>
                  <h4 className="font-display text-events-cream font-bold mt-4">Discovery Zone</h4>
                  <p className="text-events-cream/50 text-sm mt-2">
                    Your brand gets a dedicated space where attendees can learn about your company, culture, and open roles.
                  </p>
                </div>
                <div className="bg-events-card/60 rounded-xl border border-events-cream/10 p-6 text-center">
                  <div className="w-12 h-12 rounded-full bg-events-yellow/20 flex items-center justify-center mx-auto">
                    <Megaphone className="w-6 h-6 text-events-yellow" />
                  </div>
                ...
                <div className="bg-events-card/60 rounded-xl border border-events-cream/10 p-6 text-center">
                  <div className="w-12 h-12 rounded-full bg-events-coral/20 flex items-center justify-center mx-auto">
                    <HandshakeIcon className="w-6 h-6 text-events-coral" />
                  </div>
          ...
          <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
            <div className="mb-8">
              <h2 className="font-display text-3xl font-bold text-events-cream">
                Build your <span className="text-events-yellow">Brand Rep</span> card
              </h2>
