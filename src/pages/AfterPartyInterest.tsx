              ...
              >
                ...
                <p className="text-[11px] text-[#F5E6D3]/55 leading-relaxed pt-2">
                  <EditableText
                    ...
                    defaultText="By submitting, you're cool with Oakley, Popfly, and Basecamp Outdoor sending you an email about other fun stuff they're doing, and with your likeness being shared if you're captured in a photo at the event."
                    as="span"
                  />
                </p>
              </motion.form>
