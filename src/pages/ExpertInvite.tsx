    ...
    <div className="min-h-screen" style={isMN(citySlug) ? { backgroundColor: MN_FOREST } : undefined}>
      ...
      {!showForm ? (
        <>
          ...
          <section className={`relative flex flex-col overflow-hidden ${isMN(citySlug) ? "min-h-[74vh]" : "min-h-screen"}`} style={isMN(citySlug) ? { backgroundColor: MN_FOREST } : undefined}>
            ...
            <div className="relative z-10 border-b border-white/10">
              <div className="w-full mx-auto px-8 lg:px-16 py-4 flex items-center justify-between">
            ...
            <div className="relative z-10 flex-1 flex items-center">
              <div className="w-full mx-auto px-8 lg:px-16 py-12 md:py-16 w-full">
                {isMN(citySlug) ? (
        ...
        <>
          ...
          <div className="w-full mx-auto px-8 lg:px-16 py-8 md:py-12">
            <div className="mb-8">
