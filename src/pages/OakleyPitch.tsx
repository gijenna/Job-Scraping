...
const OakleyPitch = () => {
  ...
  return (
    <main className="bg-events-teal min-h-screen relative">
      ...
      {/* Free registration thanks to Oakley pill */}
      ...
      {/* Oakley Meta Demo (consolidated) */}
      <OakleyMetaDemo />

      {/* Oakley RiNo Storefront */}
        ...
        <div className="container mx-auto max-w-2xl text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="font-body text-events-cream/60 mb-8">
              Free registration thanks to Oakley. Part of Outside Days. The outdoor industry's career event of the year.
            </p>
            <a
