    ...
    <form onSubmit={submit} className="space-y-6" style={{ color: "#fff" }}>
      ...
      {step === 1 && (!attendeeId || isPreRsvpShell) ? (
        ...
        <div className="space-y-3">
          ...
          >
            By registering, you're cool with Oakley, Popfly, and Basecamp Outdoor shooting you an email about other fun stuff they're doing, and with your likeness being shared if you're captured in a photo at the event.
          </p>
        </div>
