  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-card border border-border px-3 py-2 rounded-md shadow-card">
        <p className="text-foreground text-sm font-display font-semibold">{payload[0].payload.role || payload[0].name}</p>
        <p className="text-primary text-sm">{payload[0].value}{payload[0].payload.role ? ' attendees' : '%'}</p>
      </div>
    );
  }
  return null;
  ...
  return (
    <section className="py-24 px-6" id="data">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <p className="text-primary text-xs tracking-[0.3em] uppercase mb-4 font-body">The Data That Matters</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <h3 className="font-display font-bold text-lg text-foreground mb-6">Attendee Career Fields</h3>
          ...
          <motion.div
            ...
            className="bg-gradient-card border border-border rounded-xl p-8 shadow-card"
          >
            <h3 className="font-display font-bold text-lg text-foreground mb-6">Top Roles Represented</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { num: "900+", label: "Job Seekers" },
            { num: "25+", label: "Outdoor Brands" },
            ...
            >
              <p className="font-display font-extrabold text-3xl md:text-4xl text-gradient-gold">{stat.num}</p>
