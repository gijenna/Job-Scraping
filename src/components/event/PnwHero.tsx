    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-0 items-center max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-headline font-bold text-events-cream leading-none mb-3 text-center lg:text-left" style={{ fontSize: "clamp(3.5rem, 8vw, 7rem)" }}>
            ...
            <div className="relative w-full overflow-hidden" style={{ height: "clamp(2.5rem, 5vw, 4.5rem)" }}>
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="absolute inset-x-0 top-0 font-headline font-bold whitespace-nowrap leading-none text-center lg:text-left"
                  style={{ fontSize: "clamp(2rem, 4.5vw, 4rem)", color: "#FEE123" }}
                >
                  {phrases[phraseIndex]}
                  {settled && phraseIndex === phrases.length - 1 && (
                    ...
                    >
                      <Heart className="w-5 h-5 md:w-7 md:h-7 inline-block" style={{ color: "#FEE123", fill: "#FEE123" }} />
                    </motion.span>
                  )}
                </motion.span>
              </AnimatePresence>
            ...
            >
              Basecamp Outdoor × University of Oregon
            </motion.p>
          </motion.div>
        </div>
      </div>
