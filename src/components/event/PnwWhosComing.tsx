          ...
          <div className="container mx-auto max-w-6xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-6">
              <p className="text-xs tracking-[0.3em] uppercase mb-4 font-body" style={{ color: accentColor }}>
                <EditableText settingKey="pnw_brand_reps_eyebrow" defaultText="Featured Brands" as="span" />
              </p>
              <h2 className="font-headline font-bold text-2xl md:text-4xl text-events-cream">
                <EditableText settingKey="pnw_brand_reps_headline" defaultText="Meet the Teams" as="span" />
              </h2>
            </motion.div>

            <CascadingLogoBubbles logos={bubbleLogos} bubbleColor="#e8f0d8" editKeyPrefix="pnw_bubbles" />
      ...
      {industryExperts.length > 0 && (
        <section className="py-16 md:py-24 px-6 bg-events-teal">
          <div className="container mx-auto max-w-6xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-6">
              <p className="text-xs tracking-[0.3em] uppercase mb-4 font-body" style={{ color: accentColor }}>
                <EditableText settingKey="pnw_experts_eyebrow" defaultText="Industry Experts" as="span" />
              </p>
              <h2 className="font-headline font-bold text-2xl md:text-4xl text-events-cream">
                <EditableText settingKey="pnw_experts_headline" defaultText="Industry pros you'll meet in person" as="span" />
              </h2>
            </motion.div>
